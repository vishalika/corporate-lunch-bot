...
export declare type FunctionInputs = Record<string, unknown>;
/**
 ...
 */
export declare type EventFromType<T extends string> = KnownEventFromType<T> extends never ? BaseSlackEvent<T> : KnownEventFromType<T>;
